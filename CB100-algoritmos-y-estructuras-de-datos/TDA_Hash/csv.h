...
/**
 * Recibe el buffer donde se copio la linea, el separador del archivo y la
 * cantidad de columnas Itera sobre el buffer hasta encontrar las posiciones del
 * separador, cuando la encuentra copia los substrings correspondientes hasta
 * llegar al final Devuelve un char** a un char* de strings en caso de éxito, o
 ...
 *
 * Devuelve un puntero a un archivo_csv en caso de éxito, o NULL en caso de
 * error.
 */
 ...
 * Por cada columna se debe especificar una función que se encargará de
 * convertir el valor leído a un tipo específico. Adicionalmente, se debe
 * especificar un puntero a un contexto que será pasado a cada una de las
 * funciones.
 *
 * Las funciones de parseo reciben el string leído y un puntero al contexto.
 * Devuelven true si el valor pudo ser parseado correctamente, o false en caso
 * contrario.
 *
