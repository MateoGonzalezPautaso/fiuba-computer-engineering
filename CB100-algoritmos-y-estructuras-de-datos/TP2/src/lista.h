...
/**
 * Destruye la lista aplicando la funcion destructora (si no es NULL) a cada
 * elemento.
 * */
 ...
 *
 * El elemento quitado se guarda en elemento_quitado (si se puede quitar y si no
 * es null).
 *
 ...
 *
 * El elemento encontrado se almacena en elemento_encontrado (a menos que sea
 * NULL);
 *
